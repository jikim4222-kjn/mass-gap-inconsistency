...
- `logic/`  
  Explicit statements of the axioms, theorem, and proof structure underlying
  the inconsistency argument.

- `physics-background/`  
  Supplemental notes providing physical context (vacuum energy, interlayer
  interpretations).  
  These materials provide intuition only and are **not used in the theorem,
  proof, or any logical step**.
...
The sole claim is that the standard axiomatic framing of the problem, when read
literally, is in logical tension with minimal and widely accepted physical facts.
